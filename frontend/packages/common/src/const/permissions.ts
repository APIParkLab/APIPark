...
export const PERMISSION_DEFINITION = [
  {
    ...
    'team.application.subscription.view': {
      granted: {
        anyOf: [
          { backend: ['system.workspace.application.view_all', 'team.consumer.subscription.view_subscribed_service'] }
        ]
      }
    },
        ...
        anyOf: [
          {
            backend: [
              'system.workspace.application.manager_all',
              'team.team.consumer.subscription.manager_subscribed_services'
            ]
          }
        ]
      }
